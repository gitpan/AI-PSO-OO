...
AI::PSO::OO provides the following public methods. The parameter lists shown
...
Reinitialize the optimization. I<init ()> will be called during the first call
to I<optimize ()> if it hasn't already been called.
...
=item I<getParticleState ()>

    Returns the vector of position

=item I<getBestParticles ($n)>
...
=item I<getParticleBestPos ($particleNum)>
